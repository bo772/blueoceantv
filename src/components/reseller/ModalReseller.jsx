...
const ModalReseller = ({showModalreseller, setShowModalreseller, credit, price}) => {
  return (
    <>
    {showModalreseller && (
        <>
                ...
                <div className='fixed top-0 left-0 w-full h-screen  flex items-center justify-center z-[2] '>
                    <div className='bg-white sm:w-[30rem] px-6 py-3 rounded-lg'>
                               {/* <BsXCircle className='absolute -top-6 -right-3 bg-white rounded-full  w-6 h-6  '/> */}
                                ...
                                <h1 className='text-lg uppercase underline underline-offset-4 md:text-2xl'>You have selected</h1>
                                <p className='text-xl'>{credit} Credit</p>
                                <p className='text-xl'>${price} Plan</p>
                                </div>
                            ...
                            <div className='flex justify-end mt-5'>
                                <button
                                onClick={() => setShowModalreseller(false)}
